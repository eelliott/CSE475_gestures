...
bool Creature::_rxStart(uint8_t len, uint8_t* payload) {
  ...
  if (mode) { // 0x01
    ...
    _transition(_getStateFromID(stateId));
  }
  return true;
}

State* Creature::_getStateFromID(uint8_t stateId) {
  State *found = new Wait(*this);
  return found;
//    switch (stateId) {
//      case WAIT:
//        return new Wait(*this); break;
//      //case STARTLE:
//        //foundState = new Startle(*this); break;
//      case ACTIVE1:
//        return new Active1(*this); break;
//      case ACTIVE2:
//        return new Active2(*this); break;
//      case ACTIVE3:
//        return new Active3(*this); break;
//      case AMBIENT1:
//        return new Ambient1(*this); break;
//      case AMBIENT2:
//        return new Ambient2(*this); break;
//      case AMBIENT3:
//        return new Ambient3(*this); break;
//    }
    //return *foundState;
}
