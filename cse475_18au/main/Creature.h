...
class Creature {
 ...
 private:
  ...
  /** Returns State* from given State ID */
  ...
  // ambient -> 1, 3, 5, ...
  // active -> 2, 4, 6, ....
  //State *_statesList = {new State::Ambient1(this), new State::Active1(this), new Ambient2::Ambient2(this), new Active2::Active2(this), new Ambient3::Ambient3(this), new Active3(this)};
};
